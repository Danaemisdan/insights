...
const CareersPage = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-4">
                        {roles.map((role, idx) => (
                            <div key={idx} className={`p-6 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all duration-300 hover:shadow-lg bg-gray-50 border border-gray-200 hover:border-brand-green/50`}>
                                <div>
                                ...
                                <Link
                                    to="/contact"
                                    className={`inline-flex items-center px-6 py-3 rounded-xl font-bold text-sm transition-all bg-brand-green text-white hover:bg-brand-dark`}
                                >
                                    Apply Now
            ...
            {/* Culture Section */}
            <div className={`py-20 bg-gradient-to-r from-brand-green to-brand-dark`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            <img src={images.about.meeting} alt="Team meeting" className={`w-full h-[400px] object-cover rounded-2xl shadow-2xl`} />
                        </div>
                    </div>
                </div>
            </div>

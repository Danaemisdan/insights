            ...
            <div className="relative min-h-[50vh] flex items-center overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
                    <div className="max-w-3xl">
                        <span className={`text-sm font-bold uppercase tracking-widest mb-4 block text-brand-orange`}>Know About Us</span>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                        <div>
                            ...
                            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full mb-4 bg-brand-green/10 text-brand-green`}>

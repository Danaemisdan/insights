    ...
    return (
        <div className="w-full flex items-center justify-center min-h-[60vh] bg-gray-50">
            <div className="text-center p-8 bg-white rounded-2xl shadow-sm border border-gray-100 max-w-lg w-full mx-4">
                ...
                <h1 className="text-3xl font-extrabold text-gray-900 mb-4">Our Partners</h1>
                <p className="text-gray-500 mb-8 leading-relaxed">
                    This page is currently under construction. We are working hard to bring you a comprehensive list of our valued partners. Please check back soon!
                </p>
